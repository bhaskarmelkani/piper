...
${chalk.bold("Options:")}
  ...
  --tools <tools>                Comma-separated list of tools to enable (default: read,bash,edit,write,search_code,symbols_overview,subagent)
                                 Available: read, bash, edit, write, search_code, symbols_overview, subagent, grep, find, ls
...
${chalk.bold("Available Tools (default: read, bash, edit, write, search_code, symbols_overview, subagent):")}
  ...
  subagent          - Delegate bounded work to built-in scout/planner/reviewer/worker sidecars
