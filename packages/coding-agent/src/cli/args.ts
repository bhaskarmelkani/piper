...
${chalk.bold("Options:")}
  ...
  --models <patterns>            Comma-separated model patterns for Ctrl+P cycling
	  ...
	  --tools <tools>                Comma-separated allowlist of tool names to enable
	                                 Default active built-ins: read, bash, edit, write, search_code, symbols_overview, subagent
...
${chalk.bold("Built-in Tool Names (default active: read, bash, edit, write, search_code, symbols_overview, subagent):")}
